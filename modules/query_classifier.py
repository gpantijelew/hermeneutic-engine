...
class QueryClassifier:
    ...
    DISCOURSE_PATTERNS = [
        ...
        r"vergleich", r"unterschied", r"gegenüberstellung", 
        r"vs\.", r"versus", r"anders als",
        
        # Diskurs-Marker
        r"diskutiere", r"positionen", r"meinungen",
        r"konsens", r"divergenz", r"kontroverse",
        
        # Kollektive Pluralformen
        r"wie sehen.*modelle", r"was sagen.*systeme"
    ]
    
    EXEGESIS_PATTERNS = [
        # Konzept-Fragen
        r"was ist", r"was bedeutet", r"was wäre",
        r"definier", r"bedeutung von",
        
        # Erklär-Marker
        r"erkläre", r"erläutere", r"wie funktioniert",
        r"warum", r"wieso", r"weshalb",
        
        # Analyse-Marker
        r"analyse", r"interpretier", r"hintergrund",
        r"kontext", r"einordnung"
    ]
    ...
    def classify(self, query: str, chunks: List[Dict[str, Any]]) -> QueryType:
        ...
        has_exegesis_kw = any(
            re.search(pattern, query_lower) 
            for pattern in self.EXEGESIS_PATTERNS
        )
